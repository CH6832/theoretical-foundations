...
1. **Generating Masses:**
   ...
   where $(m_\phi)$ is the mass of the Higgs boson, and $(g)$ is the coupling constant. The symmetry breaking term $( \frac{1}{4} g^2 (\phi^\dagger \phi)^2 )$ gives mass to the gauge bosons.
